...
<tr height="22">
  <td colspan="4" >&nbsp;<input type="button" class="bt" value="交卷(H)"  accesskey="H" onclick="handIn();"> <input type="button" class="bt" value="保存答案(S)"  accesskey="S" onclick="saveAnswer();"> <br/><br/>&nbsp;&nbsp;距离试卷关闭时间还有<span id="lefttime" style="color:red"/></span> </td>
</tr>
...
<tr height="5"><td><hr/></td></tr>
<tr height="22">
  <td colspan="4" >&nbsp;<input type="button" class="bt" value="交卷(H)"  accesskey="H" onclick="handIn();"> <input type="button" class="bt" value="保存答案(S)"  accesskey="S" onclick="saveAnswer();">   <br/><br/> &nbsp;&nbsp;距离试卷关闭时间还有<span id="lefttime1" style="color:red"/></span> </td>
</tr>
</table>
...
function handIn() {
  for (var i = 0; i < allquestions.length - 1; i++) {
    document.form1.answer.value += getInputValue1("s"+allquestions[i])+String.fromCharCode(2);
    document.form1.issubjective.value += getInputValue1("a"+allquestions[i])+String.fromCharCode(2);
  }
