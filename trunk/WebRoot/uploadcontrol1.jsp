...
zy.util.CsvFile csvFile = zy.util.CsvFile.getACsvFile(zy.util.CsvFile.MOTHER_PATH + java.io.File.separator + "paper_files.csv");
...
response.sendRedirect(request1.getParameter("rpath"));
%>
